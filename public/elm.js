...
var $author$project$Main$Model = F3(
	function (input, output, status) {
		return {input: input, output: output, status: status};
	});
			...
			function (level) {
				return A2(
					...
					function (_v1) {
						...
						return (_Utils_eq(
							pos,
							$elm$core$Maybe$Just(level)) || _Utils_eq(pos, $elm$core$Maybe$Nothing)) ? label : '';
					},
					list);
			},
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'Input') {
			...
			var output = $author$project$Main$format(
				$author$project$Main$viewTable(
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{output: output}),
				$author$project$Main$sendTable(output));
		}
	});
...
var $author$project$Main$blue = A3($mdgriffith$elm_ui$Element$rgb255, 18, 147, 216);
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$text('Công cụ dịch bảng biến thiên sang \\( \\LaTeX \\)')),
								A2(
								$mdgriffith$elm_ui$Element$column,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										{
											label: $mdgriffith$elm_ui$Element$Input$labelHidden('Math input'),
										...
										{
											label: $mdgriffith$elm_ui$Element$text('Dịch...'),
								...
								$mdgriffith$elm_ui$Element$text(model.status)),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$htmlAttribute(
										$elm$html$Html$Attributes$id('download')),
										$mdgriffith$elm_ui$Element$centerX,
					...
					A2(
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX]),
						$mdgriffith$elm_ui$Element$text('Made by Khang with ❤')))
				])));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Input":["String.String"],"Submit":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));